...
public class KeycloakGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>>{
    ...
    private static final Converter<Jwt, Collection<GrantedAuthority>> JWT_SCOE_GRANTED_AUTHORITIES_CONVERTER = new JwtGrantedAuthoritiesConverter();
    ...
    protected Set<String> getClientRolesFrom(Jwt jwt, String clientId) {
        ...
        Map<String, Object> resourceAccess = jwt.getClaimAsMap("ressource_access");
